import { CustomChatEvents } from "@/app/components/ui/chat/custom/annotations";
import { ChatTools } from "@/app/components/ui/chat/tools/chat-tools";
...
export function appendToolUI(
  ...
  uiStream.append(
    <ChatTools
      ...
      artifactVersion={undefined} // TODO: get artifact version from server state
    />,
  );
}
